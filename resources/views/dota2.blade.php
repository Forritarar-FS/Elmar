...
<div class="container">
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			...
			<script type="text/javascript" src="{{ asset('app/dota2/dotascript3.js') }}"></script>
			<script type="text/javascript" src="{{ asset('app/dota2/dotascript2.js') }}"></script>
			<script type="text/javascript" src="{{ asset('app/dota2/dotascript1.js') }}"></script>
